...
const base = {
  entry: {
    app: PATHS.app,
    vendor: ['core-js/fn/promise', 'react', 'react-dom', 'react-router', 'firebase', 'immutable', 'localforage', 'react-helmet', 'react-redux', 'react-router-dom', 'react-scroll', 'react-waypoint', 'redux', 'redux-thunk', 'reselect'],
  },
  output: {
    path: PATHS.build,
